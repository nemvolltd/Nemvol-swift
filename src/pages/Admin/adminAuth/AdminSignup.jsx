...
export default function AdminSignup() {
    ...
    const handleSubmit = (e) => {
        ...
        if (!email.trim() || !password.trim()) {
            setErrorMsg('Please fill in both email address and password.');
            return;
        }
        if (!agreeTerms) {
    ...
    return (
        <div className="min-h-screen w-full bg-white text-slate-900 flex select-none font-sans">
            ...
            {/* ──────────────────────────────────────────────────────────────────────── */}
            <div className="flex lg:hidden flex-col w-full min-h-screen bg-[#3b66df] relative overflow-x-hidden">
                {/* Mobile Blue Header */}
                <div className="w-full h-56 bg-gradient-to-b from-[#406ee3] via-[#355ecb] to-[#2e52b8] relative overflow-hidden flex flex-col justify-between p-6 text-white">
                    <div className="absolute top-4 -right-10 w-48 h-48 bg-white/20 rounded-full blur-2xl pointer-events-none" />
                    <div className="absolute -top-12 right-20 w-40 h-40 bg-blue-300/30 rounded-full blur-xl pointer-events-none" />
                    ...
                    <div className="relative z-10">
                        <button
                            type="button"
                            onClick={() => navigate('/')}
                            className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#1b347a]/80 hover:bg-[#1b347a] text-white text-xs font-semibold rounded-full shadow-sm backdrop-blur-md transition-all border-none cursor-pointer"
                        >
                ...
                <div className="w-full bg-white rounded-t-[36px] px-6 py-8 shadow-2xl relative z-10 -mt-16 flex flex-col gap-6 flex-1 min-h-[calc(100vh-160px)] animate-pageSlideUp">
                    <div className="text-center">
                        <h1 className="text-2xl font-extrabold text-[#3b66df] tracking-tight">Get Started</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left">
                        <fieldset className="border border-slate-200 focus-within:border-[#3b66df] rounded-2xl px-4 pb-2 pt-1 transition-colors group">
                            <legend className="text-[11px] font-semibold text-slate-500 group-focus-within:text-[#3b66df] px-1.5 bg-white">
                                Name
                            </legend>
                            <input
                                type="text"
                        ...
                        <label className="flex items-center gap-2.5 cursor-pointer mt-1">
                            <input
                                ...
                                className="w-4.5 h-4.5 rounded-md border-slate-300 text-[#3b66df] focus:ring-[#3b66df] cursor-pointer"
                            />
                            <span className="text-[11.5px] text-slate-500 font-medium">
                                I agree to the processing of <span className="text-[#3b66df] font-bold">Personal data</span>
                            </span>
                        </label>

                        <button
                            type="submit"
                            className="h-12 w-full mt-2 bg-[#3b66df] hover:bg-[#2e52b8] text-white font-bold text-sm rounded-2xl transition-all cursor-pointer flex items-center justify-center border-none"
                        >
                            Sign up
                        </button>
                    </form>
                    ...
                    <div className="flex items-center justify-center gap-6">
                        {['Facebook', 'Twitter', 'Google', 'Apple'].map((platform, i) => (
                            <button
                                key={platform}
                                type="button"
                                onClick={() => { setAdminAuth(true); navigate('/admin/overview'); }}
                    ...
                    <div className="text-center text-xs text-slate-500 font-medium pt-2">
                        ...
                        <button
                            ...
                            className="text-[#3b66df] font-bold hover:underline border-none bg-transparent cursor-pointer ml-0.5"
                        >
                            Sign in
                        </button>
                    </div>
            ...
            <div className="hidden lg:grid w-full min-h-screen grid-cols-2">
                ...
                <div className="flex flex-col justify-between p-16 bg-gradient-to-br from-[#3b82f6] via-[#2563eb] to-[#1d4ed8] text-white min-h-screen relative overflow-hidden">
                    <div className="absolute -top-32 -left-32 w-[500px] h-[500px] bg-[#60a5fa]/30 rounded-full blur-[100px] pointer-events-none" />
                    <div className="absolute -bottom-32 -right-32 w-[500px] h-[500px] bg-[#1e40af]/50 rounded-full blur-[110px] pointer-events-none" />

                    {/* Brand Badge */}
                    <div className="relative z-10 flex items-center gap-2.5">
                        <div className="w-9 h-9 rounded-xl bg-white text-blue-600 flex items-center justify-center font-black text-base shadow-sm">
                            N
                        </div>
                    ...
                    <div className="relative z-10 my-auto max-w-lg">
                        <span className="text-xs font-bold text-blue-100 uppercase tracking-widest">E-Commerce Merchant Onboarding</span>
                        <h2 className="text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight text-white mt-3">
                            Join the platform powering modern online retail
                        </h2>
                        <p className="text-xs text-blue-100/90 font-medium leading-relaxed mt-4">
                            Create your merchant account to unlock AI-assisted product generation, multi-channel order processing, and advanced sales analytics.
                        </p>
                    </div>

                    {/* Partner Brands */}
                    <div className="relative z-10 flex flex-col gap-4 pt-8 border-t border-white/15">
                        <span className="text-xs font-semibold text-blue-100/80">Trusted by modern brands</span>
                    ...
                    <div className="flex flex-col gap-6 w-full max-w-md animate-pageSlideUp">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left">
                            <div className="flex flex-col gap-1.5">
                                <label className="text-[11px] font-extrabold text-slate-800">Name</label>
                                <input
                                    type="text"
                                    value={name}
                                    onChange={(e) => setName(e.target.value)}
                                    ...
                                    required
                                    className="w-full h-12 px-4 bg-white border border-slate-200 focus:border-blue-600 focus:ring-1 focus:ring-blue-600 rounded-xl text-slate-900 text-xs font-medium placeholder:text-slate-300 focus:outline-none transition-all"
                                />
                            </div>
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder="••••••••••••"
                                        required
                                        className="w-full h-12 pl-4 pr-10 bg-white border border-slate-200 focus:border-blue-600 focus:ring-1 focus:ring-blue-600 rounded-xl text-slate-900 text-xs font-medium placeholder:text-slate-300 focus:outline-none transition-all"
                                    />
                                    <button
                                        type="button"
                            ...
                            <button
                                type="submit"
                                className="h-12 w-full mt-2 bg-[#3b82f6] hover:bg-[#2563eb] text-white font-bold text-xs rounded-xl transition-all cursor-pointer flex items-center justify-center border-none"
                            >
                                Sign Up
                            </button>
                            ...
                            <div className="text-center text-xs text-slate-500 font-medium mt-1">
                                ...
                                <button
                                    type="button"
                                    onClick={() => navigate('/admin/login')}
                                    className="text-blue-600 font-bold hover:underline border-none bg-transparent cursor-pointer ml-0.5"
                                >
                                    Sign in
                                </button>
                            </div>
