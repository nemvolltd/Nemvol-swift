        ...
        <Link to={`/product/${product.id}`} className="flex flex-col group cursor-pointer h-full justify-between bg-white p-3 rounded-2xl border border-slate-100/80 shadow-sm hover:shadow-md transition-all">
            <div className="flex flex-col">
                ...
                <div className="flex flex-col items-center text-center px-1">
                    <span className="text-[10px] md:text-xs text-slate-400 font-bold uppercase tracking-widest mb-1">
                        {product.category}
                    </span>
                    <h4 className="text-sm md:text-base font-bold text-slate-900 mb-1 truncate w-full">
                        {product.name}
                    </h4>
